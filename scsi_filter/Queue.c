...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, scsifilterQueueInitialize)
#endif

NTSTATUS
scsifilterQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = scsifilterEvtIoDeviceControl;
    queueConfig.EvtIoStop = scsifilterEvtIoStop;
